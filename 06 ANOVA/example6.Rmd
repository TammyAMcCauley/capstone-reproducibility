...
From the figure we can see that as the number of distractors increased so did the amount of time each participant needed to respond.
...
Next, I'll perform a between-subjects 2-way ANOVA looking for effects
